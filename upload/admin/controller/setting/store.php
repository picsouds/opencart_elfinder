...
class ControllerSettingStore extends Controller {
	...
	protected function getForm() {
		...
		} elseif (isset($store_info['config_image']) && $this->model_tool_image->is_fileimg($store_info['config_image'])) {	
		...
		} elseif (isset($store_info['config_logo']) && $this->model_tool_image->is_fileimg($store_info['config_logo'])) {
		...
		} elseif (isset($store_info['config_icon']) && $this->model_tool_image->is_fileimg($store_info['config_icon'])) {
