...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_image']) && $this->model_tool_image->is_fileimg($this->request->post['config_image'])) {
			$data['thumb'] = $this->model_tool_image->resize($this->request->post['config_image'], 100, 100);
		//} elseif ($this->config->get('config_image') && is_file(DIR_IMAGE . $this->config->get('config_image'))) {
		} elseif ($this->config->get('config_image') && $this->model_tool_image->is_fileimg($this->config->get('config_image'))) {
		...
		if (isset($this->request->post['config_logo']) && $this->model_tool_image->is_fileimg($this->request->post['config_logo'])) {
			$data['logo'] = $this->model_tool_image->resize($this->request->post['config_logo'], 100, 100);
		//} elseif ($this->config->get('config_logo') && is_file(DIR_IMAGE . $this->config->get('config_logo'))) {
		} elseif ($this->config->get('config_logo') && $this->model_tool_image->is_fileimg($this->config->get('config_logo'))) {
		...
		if (isset($this->request->post['config_icon']) && $this->model_tool_image->is_fileimg($this->request->post['config_icon'])) {
		...
		} elseif ($this->config->get('config_icon') && $this->model_tool_image->is_fileimg($this->config->get('config_icon'))) {
